    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="relative z-10 px-8 py-32 lg:px-12 lg:py-48">
        <div className="mx-auto max-w-5xl text-center">
          ...
          {/* Main Headline */}
          <h1 className="text-6xl md:text-8xl font-light mb-8 leading-none tracking-tight text-white">
            Escolha o plano
            <span className="block font-medium text-gradient-secondary">ideal para você</span>
          </h1>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-white/70 text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed font-light">
              Escolha o plano ideal para sua assistência e comece a crescer hoje mesmo
            </p>
          </div>
