-- =====================================================
-- SCRIPT PARA CRIAR 14 CLIENTES ALEATÓRIOS
...
-- 1. Primeiro, descubra o ID da sua empresa:
-- SELECT id, nome FROM empresas LIMIT 1;

-- 2. Substitua 'SEU_EMPRESA_ID' pelo ID real da sua empresa

-- 3. Execute o script para criar os 14 clientes

-- 4. Teste o limite criando o 15º cliente (deve ser bloqueado)
