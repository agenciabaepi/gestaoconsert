...
export default function PeriodoTestePage() {
    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="relative z-10 px-8 py-32 lg:px-12 lg:py-48">
        <div className="mx-auto max-w-5xl text-center">
          {/* Info Badge */}
          <div className="inline-flex items-center px-8 py-4 bg-[#D1FE6E]/10 backdrop-blur-xl border border-[#D1FE6E]/20 rounded-full mb-16"
               style={{
                 boxShadow: '0 8px 32px rgba(209, 254, 110, 0.1)',
                 background: 'linear-gradient(135deg, rgba(209, 254, 110, 0.05) 0%, rgba(209, 254, 110, 0.02) 100%)'
               }}>
            <div className="w-3 h-3 bg-[#D1FE6E] rounded-full mr-4 animate-pulse"></div>
            <span className="text-white/90 text-sm font-light tracking-wide">Período de Teste Ativo</span>
          </div>

          {/* Main Headline */}
          <h1 className="text-6xl md:text-8xl font-light mb-16 leading-none tracking-tight text-white">
            Conheça nossos
            <span className="block font-medium text-gradient-secondary">planos</span>
          </h1>

          {/* Sub-headline */}
          <p className="text-xl md:text-2xl text-white/80 mb-20 max-w-4xl mx-auto leading-relaxed font-light">
            Você está no período de teste gratuito. Conheça nossos planos para continuar aproveitando todos os recursos do sistema.
          </p>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-white/70 text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed font-light">
              Escolha o plano ideal para sua assistência e continue crescendo
            </p>
          </div>
            ...
            >
              <div className="text-center">
                ...
                <p className="text-white/70 text-lg mb-8 font-light">
                  Nossa equipe está pronta para te ajudar a escolher o melhor plano para sua assistência.
                </p>
