-- Executar este SQL no Supabase Dashboard para criar as tabelas do WhatsApp real
...
-- 2. Criar nova tabela de sessões
...
COMMENT ON TABLE public.whatsapp_sessions IS 'Sessões ativas do WhatsApp Web para cada empresa';
...
COMMENT ON TABLE public.whatsapp_mensagens IS 'Log de mensagens enviadas via WhatsApp Web';
